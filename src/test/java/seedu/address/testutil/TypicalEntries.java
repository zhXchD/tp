...
public class TypicalEntries {
    ...
    public static final Entry TEST_ENTRY_DIFF_DATE = new EntryBuilder().withDate("2020-12-21 19:00").build();

    public static final Entry TEST_ENTRY_DIFF_DECRIPTION = new EntryBuilder().withDescription("Meet with boss").build();
