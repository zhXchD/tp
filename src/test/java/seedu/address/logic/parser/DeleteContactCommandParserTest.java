 ...
 * variations outside of the DeleteContactCommand code. For example, inputs "1" and
 * "1 abc" take the same path through the DeleteContactCommand, and therefore we test
 * only one of them. The path variation for those two cases occur inside the
...
public class DeleteContactCommandParserTest {
    ...
    class Parse {
        @Test
        @DisplayName("should generate DeleteContactCommand from valid user input")
