...
public class LogicManagerTest {
    ...
    class Execute {
         ...
         * @see #assertCommandFailure(String, Class, String, Model)
         */
        private void assertCommandException(
                String inputCommand, String expectedMessage) {
        ...
        @Test
        @DisplayName("should throw ParseException if command format is invalid")
        ...
        @Test
        @DisplayName("should execute a valid command successfully")
        ...
        @Test
        @DisplayName("should throw command exception if storage throws an "
                + "IOException")
        public void execute_storageThrowsIoException_throwsCommandException() {
            // Setup LogicManager with JsonAddressBookIoExceptionThrowingStub
            JsonAddressBookStorage addressBookStorage =
                    new JsonAddressBookIoExceptionThrowingStub(
                            temporaryFolder.resolve(
                                    "ioExceptionAddressBook.json"));
            JsonJournalStorage journalStorage = new JsonJournalStorage(
            ...
            String expectedMessage =
                    LogicManager.FILE_OPS_ERROR_MESSAGE + DUMMY_IO_EXCEPTION;
            assertCommandFailure(
                    addCommand,
    ...
    class GetFilteredPersonList {
        ...
        @Test
        @DisplayName("should throw UnsupportedOperationException if the "
                + "readonly list is modified")
    ...
    /**
     * A stub class to throw an {@code IOException} when the save method is
     * called.
     */
    private static class JsonAddressBookIoExceptionThrowingStub
            extends JsonAddressBookStorage {
