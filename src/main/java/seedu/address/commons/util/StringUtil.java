...
public class StringUtil {
     ...
     *   Ignores case, but a full word match is required.<br>
     *   examples:
     *   <pre>
     *     containsWordIgnoreCase("ABc def", "abc") == true
     *     containsWordIgnoreCase("ABc def", "DEF") == true
     *     // Not a full word match
     *     containsWordIgnoreCase("ABc def", "AB") == false
     *   </pre>
     ...
     * e.g. empty string, "-1", "0", "+1", and " 2 " (untrimmed), "3 0"
     * (contains whitespace), "1 a" (contains letters)
