 ...
 * 1. An argument's value can be an empty string e.g. the value of {@code k/}
...
public class ArgumentTokenizer {
     ...
     * object that maps prefixes to their respective argument values. Only
     * the given prefixes will be recognized in the arguments string.
     *
     ...
     * @return           List of zero-based prefix positions in the given
     *                   arguments string
     */
     ...
     */
    private static List<PrefixPosition> findPrefixPositions(
            String argsString, Prefix prefix) {
        List<PrefixPosition> positions = new ArrayList<>();

        int prefixPosition =
                findPrefixPosition(argsString, prefix.getPrefix(), 0);
        while (prefixPosition != -1) {
            PrefixPosition extendedPrefix =
                    new PrefixPosition(prefix, prefixPosition);
     ...
     */
    private static int findPrefixPosition(
            String argsString, String prefix, int fromIndex) {
     ...
     *                        {@code argsString}
     * @return                ArgumentMultimap object that maps prefixes to
     *                        their arguments
     */
    private static ArgumentMultimap extractArguments(
            String argsString, List<PrefixPosition> prefixPositions) {

        // Sort by start position
        prefixPositions.sort((prefix1, prefix2) ->
                prefix1.getStartPosition() - prefix2.getStartPosition());
        ...
        PrefixPosition endPositionMarker =
                new PrefixPosition(new Prefix(""), argsString.length());
